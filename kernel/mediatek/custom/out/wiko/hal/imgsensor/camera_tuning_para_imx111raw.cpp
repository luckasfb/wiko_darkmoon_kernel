...
#define INCLUDE_FILENAME_TSF_PARA           "camera_tsf_para_imx111raw.h"
#define INCLUDE_FILENAME_TSF_DATA           "camera_tsf_data_imx111raw.h"
...
{{
    ...
    ISPCcmPoly22:{
        ...
        28910,    // i4B_STD
        {  // i4P00[9]
            5160000, -2933333, 333333, -673333, 3620000, -390000, -170000, -2786667, 5523333
        },
        {  // i4P10[9]
            2371581, -2377941, 6360, -222106, 4566, 202048, 404015, 1531099, -1950607
        },
        {  // i4P01[9]
            1938098, -1964699, 26600, -484197, -5612, 474431, 71347, 424219, -510943
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        ...
        // rCCTConfig
        {
			...
			2,				   // 2 4 u4BlackLightStrengthIndex
            2,    // 2 4 u4HistStretchStrengthIndex
