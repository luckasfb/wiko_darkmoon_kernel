...
UINT32 OV8850_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //LINE <> <20130716> <add the ov8850 driver> panzaoyan
UINT32 IMX111_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); //LINE <> <20130712> <add the imx111 driver> panzaoyan
...
ACDK_KD_SENSOR_INIT_FUNCTION_STRUCT kdSensorList[MAX_NUM_OF_SUPPORT_SENSOR+1] =
{
		...
		{S5K4H5YX_SENSOR_ID, SENSOR_DRVNAME_S5K4H5YX_MIPI_RAW, S5K4H5YX_MIPI_RAW_SensorInit}, 
#endif
...
#if defined(HI256_MIPI_YUV)
    {HI256_MIPI_YUV_SENSOR_ID, SENSOR_DRVNAME_HI256_MIPI_YUV, HI256_MIPI_YUV_SensorInit}, 
#endif
