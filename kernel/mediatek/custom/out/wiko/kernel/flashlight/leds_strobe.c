...
#define GPIO_ENF GPIO_CAMERA_FLASH_MODE_PIN //LINE <> <DATE20130910> <flash light> wupingzhou
#define GPIO_ENT GPIO_CAMERA_FLASH_EN_PIN  //LINE <> <DATE20130910> <flash light> wupingzhou
