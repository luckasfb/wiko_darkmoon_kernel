...
//BEGIN <> <20130813> <add the miror_Flip function> panzaoyan
void OV8850MIPI_Set_Mirror_Flip(kal_uint8 image_mirror)
{
	...
	switch (image_mirror)
	{
		case IMAGE_NORMAL:
		    OV8850_write_cmos_sensor(0x3820,0x10);
		    OV8850_write_cmos_sensor(0x3821,0x08);
		    break;
		case IMAGE_H_MIRROR:
	           OV8850_write_cmos_sensor(0x3820,0x10);
		    OV8850_write_cmos_sensor(0x3821,0x0e);
		    break;
		case IMAGE_V_MIRROR:
		    OV8850_write_cmos_sensor(0x3820,0x52);
		    OV8850_write_cmos_sensor(0x3821,0x08);
		    break;
...
//END <> <20130813> <add the miror_Flip function> panzaoyan
        ...
        MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    //OV8850_Write_Shutter(OV8850_sensor.shutter);
	    ...
	    mdelay(10);
	OV8850MIPI_Set_Mirror_Flip(IMAGE_V_MIRROR);  //LINE <> <20130813> <change the preview's direction> panzaoyan
        ...
        MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    OV8850_Set_Dummy(0, dummy_line); /* modify dummy_pixel must gen AE table again */
    mdelay(10);
    OV8850MIPI_Set_Mirror_Flip(IMAGE_V_MIRROR);  //LINE <> <20130813> <change the video's direction> panzaoyan
...
OV8850MIPI_Set_Mirror_Flip(IMAGE_V_MIRROR);//LINE <> <20130813> <change the capture's direction> panzaoyan
    return ERROR_NONE;
}   /* OV8850_Capture() */
