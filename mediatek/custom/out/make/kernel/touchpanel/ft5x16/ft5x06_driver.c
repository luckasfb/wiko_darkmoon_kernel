...
//LINE<touch panel><date20131029><tp auto update>yinhuiyong
#define  FTS_AUTO_TP_UPGRADE
#include "Ftbin_JTouch.h"
...
//LINE <touch panel> <DATE20130909> <add for focaltech debug> zhangxiaofei
...
//BEGIN <charging> <DATE20130927> <add charging flag> zhangxiaofei
kal_uint8 g_pre_tp_charger_flag = 0;
kal_uint8 g_tp_charger_flag = 0;
kal_uint8 g_need_refresh_tp_flag = 0;
//END <charging> <DATE20130927> <add charging flag> zhangxiaofei
...
{	
	//Power On CTP
#ifdef MT6582
	//hwPowerOn(MT65XX_POWER_LDO_VGP1, VOL_2800, "touch"); 
	hwPowerOn(MT6323_POWER_LDO_VGP1, VOL_2800, "touch");	//Line modified by mickal.ma
#else
...
//BEGIN<touch panel><date20131029><tp auto update>yinhuiyong
...
static  int update_firmware_thread(void *priv)
{
	...
	if( 0 == memcmp(tpd_desc, "JIEMIAN", 7))
	{
		if(tpd_fw_version > 0x12)
		{
			ft5x06_tp_upgrade(Ftbin_JTouch, sizeof(Ftbin_JTouch));
		}
	}else if( 0 == memcmp(tpd_desc, "YEJI", 4))
	{
		ft5x06_tp_upgrade(Ftbin_Yeji, sizeof(Ftbin_Yeji));
	}
	kthread_should_stop();
	return NULL;
}
...
#endif
//END<touch panel><date20131029><tp auto update>yinhuiyong
...
//BEGIN <touch panel> <DATE20130909> <add for focaltech debug> zhangxiaofei
#ifdef FTS_CTL_IIC
    ...
    //LINE <charging> <DATE20130927> <add charging flag> zhangxiaofei
    g_need_refresh_tp_flag = 1;
...
err_isp_register:
	...
	hwPowerDown(MT6323_POWER_LDO_VGP1, "touch"); 
  #endif	
	fts_5x06_isp_exit();
...
//BEGIN <touch panel> <DATE20130909> <for tocaltech debug> zhangxiaofei
#ifdef FTS_CTL_IIC
	ft_rw_iic_drv_exit();
#endif
