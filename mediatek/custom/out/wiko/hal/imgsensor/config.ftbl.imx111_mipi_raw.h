...
//                MtkCameraParameters::SCENE_MODE_NORMAL, 
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "1600x1200",    "2048x1536",    "2560x1440",    "2560x1920",    "3264x2448",    "3328x1872", "3840x2160", //LINE <> <DATE20131120> <S8513A:camera full screen 8M pixel> wupingzhou 
            )
        ), 
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::ON), 	//LINE: <> <20130820> <modified OFF to ON> panzaoyan
            ITEM_AS_VALUES_(
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                MtkCameraParameters::CAPTURE_MODE_ASD_SHOT, //LINE <> <20130820> <add the auto scene detect mode> panzaoyan
		  MtkCameraParameters::CAPTURE_MODE_MAV_SHOT, //LINE <> <20130820> <add hte multi angle capture mode> panzaoyan
            )
        ), 
    )
#endif
