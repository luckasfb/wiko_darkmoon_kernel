...
static customExifInfo_t exifTag = {CUSTOM_EXIF_STRING_MAKE,CUSTOM_EXIF_STRING_MODEL,CUSTOM_EXIF_STRING_SOFTWARE};
    if (0 != ppCustomExifTag) {
        ...
        //Add by mingji,20130228 end
        *ppCustomExifTag = (void*)&exifTag;
    }
    return 0;
#elif defined(EN_CUSTOM_EXIF_INFO)
#define CUSTOM_EXIF_STRING_MAKE  "Tinno"//LINE <SJSOIB-23 > <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
#define CUSTOM_EXIF_STRING_MODEL "S8513"//LINE <SJSOIB-23 > <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
#define CUSTOM_EXIF_STRING_SOFTWARE "S8513"//LINE <SJSOIB-23 > <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
static customExifInfo_t exifTag = {CUSTOM_EXIF_STRING_MAKE,CUSTOM_EXIF_STRING_MODEL,CUSTOM_EXIF_STRING_SOFTWARE};
    if (0 != ppCustomExifTag) {
        *ppCustomExifTag = (void*)&exifTag;
    }
