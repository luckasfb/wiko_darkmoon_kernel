...
CUSTOM_BUILD_DE_VERNO=WIKO DARKMOON Version 07
CUSTOM_BUILD_VERNO = WIKO DARKMOON Version 8
INTERNAL_BUILD_VERNO=S8513_MP_FR_WIK_12_08
...
CUSTOM_HAL_IMGSENSOR=imx111_mipi_raw ov5648_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = imx111_mipi_raw ov5648_mipi_raw
...
CUSTOM_LK_LCM = hx8394a_dsi_vdo otm1283a_hd720_dsi_vdo
...
MTK_THEMEMANAGER_APP= no #set no if turn on TUI_SUPPORT
MTK_TINY_UTIL=yes
MTK_TLR_SUPPORT=no
...
RESOURCE_OVERLAY_SUPPORT=generic navbar qHD sd_in_ex_otg
...
CUSTOM_MODEM=mt6582_s8513_hspa_gemini
...
CUSTOM_KERNEL_LCM=hx8394a_dsi_vdo otm1283a_hd720_dsi_vdo

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=hx8394a_dsi_vdo otm1283a_hd720_dsi_vdo
...
#define this for Tinno UI Camera
TINNO_UI_CAMERA_SUPPORT=yes
TINNO_UI_ACCESS_CAMERA=yes
TINNO_UI_GALLERY_SUPPORT=no


#LINE <project> <DATE20121229> <project macro> zhangxiaofei
PROJECT_S8513=yes

# Use TINNO_PROJECT_NAME in java file to identify projects.
TINNO_PROJECT_NAME=S8513A
...
TINNO_FEATURE_ONEKEY_LOCK=yes
TINNO_FEATURE_DRIVE_PROFILE=yes
TINNO_FEATURE_WIFI_HOTSPOT_AUTOPOP=yes

TINNO_APP_NOTE=yes
TINNO_APP_BOOTUPIMAGE=no
TINNO_APP_ONECLEAN=no

AKM_PSEUDO_GYRO=no

# Third party
GoNext_SUPPORT=no
FBMESSAGE_SUPPORT=no
FACEBOOK_SUPPORT=no
FLASHSHARE_SUPPORT=no
TRUSTGO_SUPPORT=no
